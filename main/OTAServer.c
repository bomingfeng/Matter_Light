...
esp_err_t OTA_update_status_handler(httpd_req_t *req)
{
	...
	sprintf(ledJSON, "{\"status\":%d,\"compile_time\":\"%s\",\"compile_date\":\"%s\",\"Page_feed\":\"%d\",\"SysStatus\":\"%d\",\"ssid_text\":\"%s\",\"pass_text\":\"%s\",\"sleep_Time\":\"%d\",\"AutolWateringTime\":\"%d\",\"ADC_DATA\":\"%d\",\"Pincode\":\"%d\",\"luminance\":\"%d\"}",  \
                       flash_status, __TIME__, __DATE__,page_feed,sse_data[0],wifi_config.sta.ssid, wifi_config.sta.password, sleep_Time, AutolWateringTime,sse_data[1],/*CHIP_DEVICE_CONFIG_USE_TEST_SETUP_PIN_CODE*/20202021,luminance);
